...
def plot_results(results):
    ...
    position_results_x(results, axarr[0][1])
    position_results_y(results, axarr[1][0])
    position_results_z(results, axarr[1][1])
    velocity_axis_results(results, axarr[2][0])
    rotation_axis_results(results, axarr[2][1])
    velocity_angles_results(results, axarr[3][0])
    agent_choices_results(results, axarr[3][1])
...
def rotation_axis_results(results, plot):
...
def velocity_angles_results(results, plot):
...
def agent_choices_results(results, plot):
